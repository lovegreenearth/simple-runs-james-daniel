...
<template>
  <div id="data-list-thumb-view" class="data-list-container"  v-if="drivers.data && drivers.data.length > 0">

    <data-view-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData" />

    <vs-table ref="table"  pagination :max-items="itemsPerPage" search :data="drivers.data">
        ...
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <!-- <vs-td class="img-container">
              <img :src="tr.profilePhoto" class="product-img" />
            </vs-td> -->
