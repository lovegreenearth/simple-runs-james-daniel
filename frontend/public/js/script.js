...
window['InitSidebar'] = function Init() {

  var sidebarCollapse = document.getElementById("sidebarCollapse");
  offcanvas_el = document.querySelector("#offcanvas");

  offcanvas = bootstrap.Offcanvas.getOrCreateInstance(offcanvas_el);
...
window['toggleMyOffcanvas'] = function toggleMyOffcanvas() {
  if (!offcanvas_el) {
    return;
  }
